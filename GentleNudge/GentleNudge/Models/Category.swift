...
final class Category: Identifiable {
    ...
    static var defaults: [Category] {
        [
            Category(name: "Today", icon: "sun.max.fill", colorName: "orange", isDefault: true, sortOrder: 0),
            Category(name: "Habits", icon: "heart.circle.fill", colorName: "red", isDefault: true, sortOrder: 1),
            Category(name: "To Read", icon: "book.fill", colorName: "blue", isDefault: true, sortOrder: 2),
            Category(name: "Startup", icon: "lightbulb.fill", colorName: "yellow", isDefault: true, sortOrder: 3),
            Category(name: "Finance", icon: "dollarsign.circle.fill", colorName: "green", isDefault: true, sortOrder: 4),
            Category(name: "House", icon: "house.fill", colorName: "orange", isDefault: true, sortOrder: 5),
            Category(name: "Photos", icon: "photo.fill", colorName: "purple", isDefault: true, sortOrder: 6),
